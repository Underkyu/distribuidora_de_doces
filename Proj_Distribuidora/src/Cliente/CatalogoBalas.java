...
public class CatalogoBalas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tituloProduto4.setText("7 Belo - Framboesa ");
        ...
        tituloProduto.setText("Bala de Goma Gomets");
        ...
        tituloProduto6.setText("Bala Azedinha - Uva");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CatalogoBalas().setVisible(true);
            }
        });
    }
