...
--
-- Host: 127.0.0.1
-- Tempo de geração: 02/10/2024 às 13:35
...
INSERT INTO `cliente` (`id_cliente`, `cpf_cliente`, `nome_cliente`, `telefone_cliente`, `endereco_cliente`, `data_nasc`, `status_cliente`) VALUES
(1, '431.758.468-70', 'José da Silva', '(11)97633-5478', 'Rua Cabo C, n° 6', '2003-07-23', 'Ótimo'),
...
INSERT INTO `fornecedor` (`id_fornecedor`, `endereco_fornecedor`, `telefone_fornecedor`) VALUES
...
--
-- Restrições para tabelas `produto_vendido`
--
ALTER TABLE `produto_vendido`
